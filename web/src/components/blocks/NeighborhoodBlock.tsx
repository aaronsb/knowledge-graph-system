    ...
    <div className="px-4 py-3 rounded-lg border-2 border-purple-500 dark:border-purple-600 bg-card dark:bg-gray-800/95 shadow-lg min-w-[280px]">
      ...
      <div className="flex items-center gap-2 mb-3">
        ...
        <input
          ...
          className="w-16 px-2 py-1 text-sm border border-border dark:border-gray-600 bg-background dark:bg-gray-900 text-foreground dark:text-gray-100 rounded focus:outline-hidden focus:ring-2 focus:ring-purple-500 dark:focus:ring-purple-400 nodrag"
        />
