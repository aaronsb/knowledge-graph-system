      ...
      <div className="space-y-2">
        ...
        <div className="flex gap-1">
          <input
            ...
            className={`flex-1 px-2 py-1 text-xs border ${regexError ? 'border-red-500 dark:border-red-400' : 'border-border dark:border-gray-600'} bg-background dark:bg-gray-900 text-foreground dark:text-gray-100 rounded focus:outline-hidden focus:ring-1 focus:ring-blue-500 dark:focus:ring-blue-400`}
          />
          <button
