    ...
    return (
      <div className={`space-y-2 ${className}`}>
        ...
        <div className="h-3 bg-gray-200 dark:bg-gray-700 rounded-full overflow-hidden">
          <div
            className="h-full bg-gradient-to-r from-blue-500 to-blue-400 dark:from-blue-400 dark:to-blue-300 transition-all duration-300"
            style={{ width: `${percent}%` }}
          />
        </div>
    ...
    <div className={`space-y-3 ${className}`}>
      ...
      <div>
        ...
        <div className="h-4 bg-gray-200 dark:bg-gray-700 rounded-full overflow-hidden">
          <div
            className="h-full bg-gradient-to-r from-blue-500 to-blue-400 dark:from-blue-400 dark:to-blue-300 transition-all duration-300 relative"
            style={{ width: `${percent}%` }}
          >
      ...
      <div className="grid grid-cols-2 gap-3">
        ...
        <div className="bg-gray-50 dark:bg-gray-800/50 rounded-lg p-2">
          ...
          <div className={`text-lg font-semibold ${hitRate > 50 ? 'text-green-600 dark:text-green-400' : 'text-card-foreground dark:text-gray-200'}`}>
            {hitRate}%
          </div>
        </div>
      </div>
...
export const ProgressBar: React.FC<{
  ...
  return (
    <div className={`w-full bg-gray-200 dark:bg-gray-700 rounded-full overflow-hidden ${className}`}>
      <div
        className={`${heightClass} bg-blue-500 dark:bg-blue-400 transition-all duration-300`}
