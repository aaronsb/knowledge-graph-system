...
echo ""
echo -e "${YELLOW}Development defaults (insecure - change ASAP):${NC}"
echo "  • Admin password: ${RED}Password1!${NC}"
echo "  • Database password: ${RED}password${NC}"
...
echo ""
echo -e "${YELLOW}Credentials (${RED}INSECURE - CHANGE IMMEDIATELY${YELLOW}):${NC}"
echo "  • Username: admin"
echo "  • Password: ${RED}Password1!${NC}"
echo ""
