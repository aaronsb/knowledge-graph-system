...
from api.app.lib.vocabulary_scoring import VocabularyScorer, EdgeTypeScore
from api.app.lib.category_classifier import CategoryClassifier, CategoryClassification
from api.app.lib.synonym_detector import SynonymDetector, SynonymCandidate
...
if __name__ == "__main__":
    ...
    print()
    print("Usage:")
    print("  from api.app.services.vocabulary_manager import VocabularyManager")
