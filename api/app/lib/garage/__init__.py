...
Usage:
    ...
    from api.app.lib.garage import get_image_storage, get_projection_storage, get_artifact_storage
    ...
    from api.app.lib.garage import GarageBaseClient, ImageStorageService
