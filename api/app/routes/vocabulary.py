...
from api.app.dependencies.auth import CurrentUser, require_role, require_permission
...
async def analyze_vocabulary_type(
    ...
    **Authorization:** Requires `vocabulary:read` permission
    ...
    try:
        from api.app.lib.age_client import AGEClient
        from api.app.lib.vocabulary_categorizer import VocabularyCategorizer, CATEGORY_SEEDS
        import numpy as np
...
async def measure_epistemic_status(
    ...
    **Authorization:** Requires `vocabulary:write` permission
    ...
    from api.app.services.epistemic_status_service import EpistemicStatusService
