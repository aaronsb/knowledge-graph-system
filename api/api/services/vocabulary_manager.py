...
from api.api.lib.vocabulary_scoring import VocabularyScorer, EdgeTypeScore
from api.api.lib.category_classifier import CategoryClassifier, CategoryClassification
from api.api.lib.synonym_detector import SynonymDetector, SynonymCandidate
from api.api.lib.pruning_strategies import (
    PruningStrategy,
...
class VocabularyManager:
    ...
    async def aitl_consolidate_vocabulary(
        ...
        """
        from api.api.lib.pruning_strategies import llm_evaluate_merge
...
if __name__ == "__main__":
    ...
    print()
    print("Usage:")
    print("  from api.api.services.vocabulary_manager import VocabularyManager")
