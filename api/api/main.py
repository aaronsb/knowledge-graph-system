...
from .workers.polarity_axis_worker import run_polarity_axis_worker
...
async def startup_event():
    ...
    queue.register_worker("polarity_axis_analysis", run_polarity_axis_worker)  # ADR-070
    logger.info("✅ Workers registered: ingestion, ingest_image, restore, vocab_refresh, vocab_consolidate, epistemic_remeasurement, source_embedding, polarity_axis_analysis")
