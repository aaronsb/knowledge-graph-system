...
Usage:
    from api.api.lib.pruning_strategies import PruningStrategy, ActionRecommendation
...
from api.api.lib.synonym_detector import SynonymCandidate, SynonymStrength
from api.api.lib.vocabulary_scoring import EdgeTypeScore
...
if __name__ == "__main__":
    ...
    print()
    print("Usage:")
    print("  from api.api.lib.pruning_strategies import PruningStrategy")
