...
Usage:
    from api.api.lib.category_classifier import CategoryClassifier
...
import numpy as np
from api.api.constants import RELATIONSHIP_CATEGORIES
...
if __name__ == "__main__":
    ...
    print()
    print("Usage:")
    print("  from api.api.lib.category_classifier import CategoryClassifier")
