...
class SourceDocumentService:
    ...
    def compute_identity(
        ...
        # 32 chars = 128 bits = UUID-equivalent collision resistance
        # for future sharded universe with billions of documents
        garage_key = f"sources/{safe_ontology}/{content_hash[:32]}.{ext}"
