...
ingestCommand
  ...
  .option('-r, --recurse', 'Recursively scan subdirectories (use with -d to limit depth)', false)
  .option('-d, --depth <n>', 'Maximum recursion depth (0=current dir only, 1=one level deep, "all"=unlimited)', '0')
