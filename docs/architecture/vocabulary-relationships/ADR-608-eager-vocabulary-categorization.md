...
### The Bounded Exploration Model (ADR-607)
...
4. **Consolidation cycle:** ADR-607 provides pruning and synonym merging to manage growth
...
**Use cases:**
1. **Synonym detection** for ADR-607 consolidation
...
**Related ADRs:**
- ADR-607: Vocabulary Expansion-Consolidation Cycle
