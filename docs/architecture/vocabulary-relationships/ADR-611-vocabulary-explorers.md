...
The knowledge graph system uses a self-refining vocabulary of edge types (ADR-603) that grows organically as documents are ingested. With 100 edge types across 9+ categories and 4,856 relationships in the current database, understanding vocabulary usage patterns becomes increasingly important for:
...
- ADR-605: Vocabulary Category Scoring
- ADR-608: Vocabulary Similarity Analysis
- ADR-610: Epistemic Status Classification
- ADR-813: Polarity Axis Analysis (similar explorer pattern)
