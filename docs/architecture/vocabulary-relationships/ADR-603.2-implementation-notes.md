...
# ADR-603.2: Implementation Quick Reference
...
```python
is_builtin == TRUE  # 30 core types from ADR-600
...
- Full ADR: `docs/architecture/ADR-603-automatic-edge-vocabulary-expansion.md`
- ADR-600 (30-type taxonomy): `docs/architecture/ADR-600-semantic-relationship-taxonomy.md`
- Constants: `api/app/constants.py` (RELATIONSHIP_CATEGORIES)
