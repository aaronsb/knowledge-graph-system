...
ADR-601 establishes a curator-driven workflow for managing relationship vocabulary growth. While effective, the manual curation process has scalability limitations:

### Current Curation Workflow (ADR-601)
...
- **Related ADRs:**
  ...
  - ADR-300: Job Approval Workflow (human-in-loop pattern)
