...
# ADR-305.1: Multimodal Image Ingestion with Visual Context Injection
...
- **Philosophy alignment**: Same principles that led us to escape Neo4j via Apache AGE (ADR-208)
...
# Garage Storage (ADR-405: Credentials encrypted in database)
