...
- **ADR-300**: Job Approval Workflow (establishes preprocessing before ingestion)
- **ADR-208**: Apache AGE Migration (source of string escaping challenges)
- **ADR-600**: Semantic Relationship Taxonomy (concepts we're trying to extract)
