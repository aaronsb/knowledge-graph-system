...
- Type normalized via existing mapper (ADR-603)
...
- ADR-603: Relationship vocabulary normalization
- ADR-808: Grounding strength calculation
- ADR-809: Unified embedding generation
- ADR-606: Query safety patterns
