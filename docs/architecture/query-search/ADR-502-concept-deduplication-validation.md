...
- **ADR-208**: Apache AGE migration (graph storage layer)
- **ADR-209**: PostgreSQL multi-schema (job tracking)
- **ADR-902**: Node fitness scoring (concept quality metrics)
- **ADR-905**: Source text tracking (evidence preservation)
