...
Demonstrates ADR-811: How multiple opposing pairs create a robust polarity axis
"""
...
class PolarityAxisDemo:
    ...
    def create_3d_plot(self):
        ...
        fig.suptitle('Polarity Axis Triangulation (ADR-811)', fontsize=16, fontweight='bold')
