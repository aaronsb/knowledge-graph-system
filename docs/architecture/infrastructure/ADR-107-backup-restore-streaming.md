...
> streaming foundation rather than replacing it, so ADR-107 remains Accepted; the
...
- **ADR-106:** API Server Architecture (job queue pattern)
- **ADR-707:** Unified TypeScript Client (config management)
