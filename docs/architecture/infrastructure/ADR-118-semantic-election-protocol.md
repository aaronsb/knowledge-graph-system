...
- **Coherence monitoring**: Mean pairwise similarity detects domain drift (ADR-808)
- **Grounding scores**: Polarity axis triangulation measures evidential support (ADR-811)
...
- **ADR-808**: Probabilistic Truth Convergence (grounding scores)
- **ADR-112**: CDN and Serverless Deployment (sharding context)
- **ADR-811**: Polarity Axis Triangulation (coherence calculation)
