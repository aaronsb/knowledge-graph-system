...
| `epistemic_remeasurement` | Every hour | `EpistemicRemeasurementLauncher` | `epistemic_remeasurement_worker` | Re-measure epistemic status when vocabulary changes exceed threshold (ADR-610 Phase 2) |
...
- **ADR-106:** API Server Architecture
- **ADR-300:** Job Approval Workflow
- **ADR-810:** Rate Limiting and Per-Provider Concurrency
