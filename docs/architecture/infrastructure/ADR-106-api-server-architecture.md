...
**POST /jobs/{job_id}/approve** (ADR-300)
```json
{
  "job_id": "job_abc123",
  "status": "approved",
...
- **ADR-706**: Project Structure (why code lives in `src/`)
- **ADR-707**: Unified TypeScript Client (CLI + MCP consumer of this API)
- **ADR-300**: Job Approval Workflow (pre-ingestion analysis and scheduler)
...
**Last Updated:** 2025-10-07 (Added ADR-300 endpoints)
