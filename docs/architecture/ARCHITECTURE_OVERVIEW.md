...
See [ADR-044](ai-embeddings/ADR-044-probabilistic-truth-convergence.md) for probabilistic truth, [ADR-058](ai-embeddings/ADR-058-polarity-axis-triangulation.md) for geometric grounding, and [ADR-063](query-search/ADR-063-semantic-diversity-authenticity-signal.md) for authenticity signals.
...
See [ADR-013](user-interfaces/ADR-013-unified-typescript-client.md) for detailed design.
