...
See [ADR-044](ADR-044-probabilistic-truth-convergence.md) for probabilistic truth, [ADR-058](ADR-058-polarity-axis-triangulation.md) for geometric grounding, and [ADR-063](ADR-063-semantic-diversity-authenticity.md) for authenticity signals.
