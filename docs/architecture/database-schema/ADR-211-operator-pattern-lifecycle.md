...
- **ADR-405:** Encrypted Credential Storage (ENCRYPTION_KEY usage)
- **ADR-406:** OAuth 2.0 Authentication (OAUTH_SIGNING_KEY usage)
- **ADR-210:** Database Schema Migration Management (automatic migrations)
- **ADR-305:** Garage Object Storage (configuration via operator)
- **ADR-117:** Deployment Topology (standalone installer, GHCR images)
