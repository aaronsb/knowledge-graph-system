...
# ADR-715.1: FUSE Driver Implementation Specifics

## Overview

This document captures specific implementation details for the kg-fuse driver, building on the conceptual design in ADR-715.
...
- ADR-715: Semantic FUSE Filesystem (conceptual design)
