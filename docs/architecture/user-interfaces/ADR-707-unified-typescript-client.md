...
6. source
   - action: "image" (ADR-305 image retrieval)
...
- **ADR-706**: Project Structure (why client/ is separate from src/)
- **ADR-106**: API Server Architecture (what this client connects to)
