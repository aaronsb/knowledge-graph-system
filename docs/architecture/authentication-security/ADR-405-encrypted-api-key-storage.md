...
1. **Separation of Concerns**
   - `jwt_secret`: Signs/verifies authentication tokens (ADR-403)
...
echo ""
echo "Next steps:"
echo "  1. Update docker-compose.yml to use secrets (see ADR-405)"
...
"""
Docker/Podman secrets backend (ADR-405 Phase 1).
...
- Related: ADR-403 (User Management & Authentication)
- Related: ADR-209 (Multi-Schema PostgreSQL Architecture)
