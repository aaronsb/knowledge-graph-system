...
- **ADR-707:** Unified TypeScript Client (MCP server architecture)
- **ADR-304:** Silent Enrichment (source metadata)
- **ADR-305:** Image Ingestion (visual source handling)
- **ADR-407:** Endpoint Security Architecture (authentication model)
