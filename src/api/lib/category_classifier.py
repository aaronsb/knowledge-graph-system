...
Usage:
    from src.api.lib.category_classifier import CategoryClassifier
...
import numpy as np
from src.api.constants import RELATIONSHIP_CATEGORIES
...
if __name__ == "__main__":
    ...
    print()
    print("Usage:")
    print("  from src.api.lib.category_classifier import CategoryClassifier")
