-- Migration 046: Breathing Proposals (ADR-200 Phase 3b)
-- Stores promotion and demotion proposals generated by the breathing worker.
-- Proposals are reviewed by humans before execution (HITL pattern).

-- Create breathing proposals table
CREATE TABLE IF NOT EXISTS kg_api.breathing_proposals (
...
CREATE INDEX IF NOT EXISTS idx_breathing_proposals_status
